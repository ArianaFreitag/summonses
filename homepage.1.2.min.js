(this || self || window).Two = function(e) {
        ...
        var t = Object.prototype.toString,
            B = {
                ...
                isEmpty: function(e) {
                    return null == e || (g && (B.isArray(e) || B.isString(e) || B.isArguments(e)) ? 0 === e.length : 0 === B.keys(e).length)
                },
                ...
                each: function(e, t, i) {
                    for (var r = i || this, n = !g(e) && B.keys(e), s = (n || e).length, o = 0; o < s; o++) {
                        var a = n ? n[o] : o;
                        t.call(r, e[a], a, e)
                    }
                    return e
                ...
                map: function(e, t, i) {
                    for (var r = i || this, n = !g(e) && B.keys(e), s = (n || e).length, o = [], a = 0; a < s; a++) {
                        var l = n ? n[a] : a;
        ...
        B.extend(O, {
            ...
            Utils: B.extend(B, {
                    ...
                    path: function(e, t) {
                        ...
                        if (B.each(m, function(e, t) {
                                var i, r, n, s, o, a, l, c, h, d, u, f, g = e[0],
                                    p = g.toLowerCase();
                                switch (k = (k = (k = e.slice(1).trim()).replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g, function(e, t, i) {
                                    ...
                                    case "c":
                                    case "s":
                                        s = M.x, o = M.y, A || (A = new O.Vector), u = /c/i.test(p) ? (a = parseFloat(k[0]), l = parseFloat(k[1]), c = parseFloat(k[2]), h = parseFloat(k[3]), d = parseFloat(k[4]), parseFloat(k[5])) : (a = (f = I(M, A, R)).x, l = f.y, c = parseFloat(k[0]), h = parseFloat(k[1]), d = parseFloat(k[2]), parseFloat(k[3])), R && (a += s, l += o, c += s, h += o, d += s, u += o), B.isObject(M.controls) || O.Anchor.AppendCurveProperties(M), M.controls.right.set(a - M.x, l - M.y), i = new O.Anchor(d, u, c - d, h - u, void 0, void 0, O.Commands.curve), A = (M = i).controls.left;
                                        break;
                                    case "t":
                                    case "q":
                                        s = M.x, o = M.y, A || (A = new O.Vector), l = A.isZero() ? (a = s, o) : (a = A.x, A.y), u = /q/i.test(p) ? (c = parseFloat(k[0]), h = parseFloat(k[1]), d = parseFloat(k[2]), parseFloat(k[3])) : (c = (f = I(M, A, R)).x, h = f.y, d = parseFloat(k[0]), parseFloat(k[1])), R && (a += s, l += o, c += s, h += o, d += s, u += o), B.isObject(M.controls) || O.Anchor.AppendCurveProperties(M), M.controls.right.set(a - M.x, l - M.y), i = new O.Anchor(d, u, c - d, h - u, void 0, void 0, O.Commands.curve), A = (M = i).controls.left;
                                        break;
                                    case "a":
                                        s = M.x, o = M.y;
                ...
                Events: {
                    on: function(e, t) {
                        return this._events || (this._events = {}), (this._events[e] || (this._events[e] = [])).push(t), this
                    },
                    off: function(e, t) {
        ...
        B.extend(O.prototype, O.Utils.Events, {
            ...
            update: function() {
                var e = !!this._lastFrame,
                    t = s.now();
                e && (this.timeDelta = parseFloat((t - this._lastFrame).toFixed(3))), this._lastFrame = t;
                var i = this.width,
                    r = this.height,
                    n = this.renderer;
            ...
            makeCurve: function(e) {
                ...
                return a.center().translation.set(l.left + l.width / 2, l.top + l.height / 2), this.scene.add(a), a
            },
    ...
    function(P) {
        var R = P.Utils.mod,
            ...
            e = P[P.Types.svg] = function(e) {
                this.domElement = e.domElement || a.createElement("svg"), this.scene = new P.Group, (this.scene.parent = this).defs = a.createElement("defs"), this.domElement.appendChild(this.defs), this.domElement.defs = this.defs, this.domElement.style.overflow = "hidden"
            };
        s.extend(e, {
            Utils: a
            ...
            Z = {
                ...
                path: {
                    render: function(e, t, i) {
                        ...
                        if (this._update(), r = this._matrix.elements, n = this._stroke, s = this._linewidth, o = this._fill, a = this._opacity * this.parent._renderer.opacity, l = this._visible, c = this._cap, h = this._join, d = this._miter, u = this._closed, p = (g = (f = this._renderer.vertices).length) - 1, F = Q(r), I = this.dashes, B = this._clip, !t && (!l || B)) return this;
    ...
    function(W) {
        ...
        var t = W[W.Types.webgl] = function(e) {
            var t, i, r, n;
            if (this.domElement = e.domElement || document.createElement("canvas"), Y.isUndefined(e.offscreenElement) || (K.canvas = e.offscreenElement, K.ctx = K.canvas.getContext("2d")), this.scene = new W.Group, (this.scene.parent = this)._renderer = {
    ...
    function(i) {
        ...
        e.extend(r, {
            ...
            _update: function(e) {
                return !this._matrix.manual && this._flagMatrix && (this._matrix.identity().translate(this.translation.x, this.translation.y), this._scale instanceof i.Vector ? this._matrix.scale(this._scale.x, this._scale.y) : this._matrix.scale(this._scale), this._matrix.rotate(this.rotation)), e && this.parent && this.parent._update && this.parent._update(), this
            },
            flagReset: function() {
    ...
    function(I) {
        ...
        function o(e, t, i) {
            ...
            return r = t.x, a = t.y, n = (d || t).x, l = (d || t).y, s = (u || e).x, c = (u || e).y, o = e.x, h = e.y, d && t._relative && (n += t.x, l += t.y), u && e._relative && (s += e.x, c += e.y), I.Utils.getCurveLength(r, a, n, l, s, c, o, h, i)
        }

        function l(e, t, i) {
            var r, n, s, o, a, l, c, h, d = t.controls && t.controls.right,
                u = e.controls && e.controls.left;
            return r = t.x, a = t.y, n = (d || t).x, l = (d || t).y, s = (u || e).x, c = (u || e).y, o = e.x, h = e.y, d && t._relative && (n += t.x, l += t.y), u && e._relative && (s += e.x, c += e.y), I.Utils.subdivide(r, a, n, l, s, c, o, h, i)
        }
        U.extend(n, {
            ...
            MakeObservable: function(e) {
                I.Shape.MakeObservable(e), U.each(n.Properties.slice(2, 9), I.Utils.defineProperty, e), Object.defineProperty(e, "fill", {
                    ...
                    set: function(e) {
                        ...
                        this._collection && this._collection.unbind(I.Events.insert, t).unbind(I.Events.remove, i), e instanceof I.Utils.Collection ? this._collection = e : this._collection = new I.Utils.Collection(e || []), this._collection.bind(I.Events.insert, t).bind(I.Events.remove, i), t(this._collection)
                    }
            ...
            getBoundingClientRect: function(e) {
                ...
                for (n = 1; n < r; n++)
                    if (l = this._renderer.vertices[n], (s = this._renderer.vertices[n - 1]).controls && l.controls) {
            ...
            getPointAt: function(e, t) {
                ...
                if (!x) return b;
                if (!b) return x;
                m = b.controls && b.controls.right, p = x.controls && x.controls.left, o = b.x, d = b.y, a = (m || b).x, u = (m || b).y, l = (p || x).x, f = (p || x).y, c = x.x, g = x.y, m && b.relative && (a += b.x, u += b.y), p && x.relative && (l += x.x, f += x.y), s = I.Utils.getComponentOnCubicBezier(e, o, a, l, c), h = I.Utils.getComponentOnCubicBezier(e, d, u, f, g);
            ...
            _update: function() {
                if (this._flagVertices) {
                    ...
                    for (var e, t, i, r, n, s = this._collection.length, o = this._closed, a = Math.min(this._beginning, this._ending), l = Math.max(this._beginning, this._ending), c = b(this, a * this._length), h = b(this, l * this._length), d = m(c), u = y(h), f = this._renderer.vertices.length = 0; f < s; f++) this._renderer.collection.length <= f && this._renderer.collection.push(new I.Anchor), u < f && !t ? ((n = this._renderer.collection[f]).copy(this._collection[f]), this.getPointAt(l, n), n.command = this._renderer.collection[f].command, this._renderer.vertices.push(n), t = n, (i = this._collection[f - 1]) && i.controls && (n.controls.right.clear(), this._renderer.collection[f - 1].controls.right.clear().lerp(i.controls.right, n.t))) : d <= f && f <= u && (n = this._renderer.collection[f].copy(this._collection[f]), this._renderer.vertices.push(n), f === u && x(this, l) ? (t = n, !o && t.controls && t.controls.right.clear()) : f === d && x(this, a) && ((e = n).command = I.Commands.move, !o && e.controls && e.controls.left.clear()));
                    0 < d && !e && (f = d - 1, (n = this._renderer.collection[f]).copy(this._collection[f]), this.getPointAt(a, n), n.command = I.Commands.move, this._renderer.vertices.unshift(n), e = n, (r = this._collection[f + 1]) && r.controls && (n.controls.left.clear(), this._renderer.collection[f + 1].controls.left.copy(r.controls.left).lerp(I.Vector.zero, n.t)))
                }
        ...
        i.extend(r, {
            ...
            _update: function() {
                if (this._flagWidth || this._flagHeight) {
                    var e = this._width / 2,
                        t = this._height / 2;
                    this.vertices[0].set(-e, -t).add(this._origin).command = n.Commands.move, this.vertices[1].set(e, -t).add(this._origin).command = n.Commands.line, this.vertices[2].set(e, t).add(this._origin).command = n.Commands.line, this.vertices[3].set(-e, t).add(this._origin).command = n.Commands.line, this.vertices[4] && (this.vertices[4].set(-e, -t).add(this._origin).command = n.Commands.line)
                }
        ...
        o.extend(c, {
            ...
            _update: function() {
                if (this._flagWidth || this._flagHeight || this._flagRadius) {
                    ...
                    var s = r / 2,
                        o = n / 2;
                    (i = this.vertices[0]).x = -(s - e), i.y = -o, (i = this.vertices[1]).x = s - e, i.y = -o, i.controls.left.clear(), i.controls.right.x = e, i.controls.right.y = 0, (i = this.vertices[2]).x = s, i.y = -(o - t), i.controls.right.clear(), i.controls.left.clear(), (i = this.vertices[3]).x = s, i.y = o - t, i.controls.left.clear(), i.controls.right.x = 0, i.controls.right.y = t, (i = this.vertices[4]).x = s - e, i.y = o, i.controls.right.clear(), i.controls.left.clear(), (i = this.vertices[5]).x = -(s - e), i.y = o, i.controls.left.clear(), i.controls.right.x = -e, i.controls.right.y = 0, (i = this.vertices[6]).x = -s, i.y = o - t, i.controls.left.clear(), i.controls.right.clear(), (i = this.vertices[7]).x = -s, i.y = -(o - t), i.controls.left.clear(), i.controls.right.x = 0, i.controls.right.y = -t, (i = this.vertices[8]).x = -(s - e), i.y = -o, i.controls.left.clear(), i.controls.right.clear(), (i = this.vertices[9]).copy(this.vertices[8])
                }
                return l.prototype._update.call(this), this
            },
            flagReset: function() {
    ...
    function(r) {
        var n = r.Utils,
            s = r.Stop = function(e, t, i) {
                this._renderer = {}, this._renderer.type = "stop", this.offset = n.isNumber(e) ? e : s.Index <= 0 ? 0 : 1, this.opacity = n.isNumber(i) ? i : 1, this.color = n.isString(t) ? t : s.Index <= 0 ? "#fff" : "#000", s.Index = (s.Index + 1) % 2
            };
        n.extend(s, {
            Index: 0,
            ...
            MakeObservable: function(e) {
                n.each(o.Properties, r.Utils.defineProperty, e), Object.defineProperty(e, "stops", {
                    ...
                    set: function(e) {
                        ...
                        this._stops && this._stops.unbind(r.Events.insert, t).unbind(r.Events.remove, i), this._stops = new r.Utils.Collection((e || []).slice(0)), this._stops.bind(r.Events.insert, t).bind(r.Events.remove, i), t(this._stops)
                    }
                })
            },
            FlagStops: function() {
    ...
    function(o) {
        var a = o.Utils,
            l = o.LinearGradient = function(e, t, i, r, n) {
                ...
                this.left = (new o.Vector).bind(o.Events.change, s), this.right = (new o.Vector).bind(o.Events.change, s), a.isNumber(e) && (this.left.x = e), a.isNumber(t) && (this.left.y = t), a.isNumber(i) && (this.right.x = i), a.isNumber(r) && (this.right.y = r)
            };
        a.extend(l, {
    ...
    function(o) {
        var a = o.Utils,
            r = o.RadialGradient = function(e, t, i, r, n, s) {
                o.Gradient.call(this, r), this._renderer.type = "radial-gradient", this.center = (new o.Vector).bind(o.Events.change, a.bind(function() {
                    this._flagCenter = !0
                }, this)), this.radius = a.isNumber(i) ? i : 20, this.focal = (new o.Vector).bind(o.Events.change, a.bind(function() {
                    this._flagFocal = !0
        ...
        o.extend(a, {
            ...
            _update: function() {
                return (this._flagSrc || this._flagImage) && (this.trigger(s.Events.change), (this._flagSrc || this._flagImage) && (this.loaded = !1, a.load(this, o.bind(function() {
                    this.loaded = !0, this.trigger(s.Events.change).trigger(s.Events.load)
    ...
    function(c) {
        ...
        h.extend(s, {
            ...
            MakeObservable: function(e) {
                d.MakeObservable(e), h.each(s.Properties, c.Utils.defineProperty, e), Object.defineProperty(e, "textures", {
                    ...
                    set: function(e) {
                        ...
                        this._textures && this._textures.unbind(c.Events.insert, t).unbind(c.Events.remove, i), this._textures = new c.Utils.Collection((e || []).slice(0)), this._textures.bind(c.Events.insert, t).bind(c.Events.remove, i), t(this._textures)
                    }
                })
            },
            ...
            _update: function() {
                ...
                return this._flagTextures && (this._amount = l.length), this._flagFrameRate && (this._duration = 1e3 * this._amount / this._frameRate), this._playing && 0 < this._frameRate ? (r = this._amount, h.isNaN(this._lastFrame) && (this._lastFrame = r - 1), i = h.performance.now() - this._startTime, n = 1e3 * ((a = this._lastFrame + 1) - this._firstFrame) / this._frameRate, this._loop ? i %= n : i = Math.min(i, n), o = h.lerp(this._firstFrame, a, i / n), (o = Math.floor(o)) !== this._index && (this._index = o, (s = l[this._index]).loaded && (e = s.image.width, t = s.image.height, this.width !== e && (this.width = e), this.height !== t && (this.height = t), this.fill = s, o >= this._lastFrame - 1 && this._onLastFrame && this._onLastFrame()))) : !this._flagIndex && this.fill instanceof c.Texture || ((s = l[this._index]).loaded && (e = s.image.width, t = s.image.height, this.width !== e && (this.width = e), this.height !== t && (this.height = t)), this.fill = s), d.prototype._update.call(this), this
            },
            flagReset: function() {
        ...
        return function s(o, a, l) {
            ...
            1: [function(e, t, i) {
                ...
                ! function() {
                    ...
                    var r = function(e, t) {
                        ...
                        e.render.fillStyle = e.render.fillStyle || i, e.render.strokeStyle = e.render.strokeStyle || "#000", e.render.sprite.xOffset += -(e.bounds.min.x - e.position.x) / (e.bounds.max.x - e.bounds.min.x), e.render.sprite.yOffset += -(e.bounds.min.y - e.position.y) / (e.bounds.max.y - e.bounds.min.y)
                    };
                    c.set = function(e, t, i) {
                        ...
                        if (1 !== e.parts.length) {
                            ...
                            e.area = l.area, (e.parent = e).position.x = l.centre.x, e.position.y = l.centre.y, e.positionPrev.x = l.centre.x, e.positionPrev.y = l.centre.y, c.setMass(e, l.mass), c.setInertia(e, l.inertia), c.setPosition(e, l.centre)
                        }
            ...
            2: [function(e, t, i) {
                ...
                d.create = function(e) {
                    ...
                    for (var t = d.allBodies(e).concat(d.allConstraints(e)).concat(d.allComposites(e)), i = 0; i < t.length; i++) t[i].id = s.nextId();
            ...
            8: [function(e, t, i) {
                ...
                c._pairMaxIdleLife = 1e3, c.create = function(e) {
                    ...
                    var r, n, s, o, a = e.list,
                        ...
                        d = e.collisionActive,
                        u = [];
                    for (c.length = 0, h.length = 0, o = d.length = 0; o < t.length; o++)(r = t[o]).collided && (n = f.id(r.bodyA, r.bodyB), u.push(n), (s = l[n]) ? (s.isActive ? d.push(s) : c.push(s), f.update(s, r, i)) : (s = f.create(r, i), l[n] = s, c.push(s), a.push(s)));
                    for (o = 0; o < a.length; o++)(s = a[o]).isActive && -1 === g.indexOf(u, s.id) && (f.setActive(s, !1, i), h.push(s))
                }, c.removeOld = function(e, t) {
                    var i, r, n, s, o = e.list,
                        a = e.table,
                        l = [];
                    for (s = 0; s < o.length; s++)(r = (i = o[s]).collision).bodyA.isSleeping || r.bodyB.isSleeping ? i.timeUpdated = t : t - i.timeUpdated > c._pairMaxIdleLife && l.push(s);
                    for (s = 0; s < l.length; s++) delete a[(i = o[n = l[s] - s]).id], o.splice(n, 1)
                }, c.clear = function(e) {
            ...
            10: [function(e, t, i) {
                ...
                N._restingThresh = 4, N._restingThreshTangent = 6, N._positionDampen = .9, N._positionWarming = .8, N._frictionNormalMultiplier = 5, N.preSolvePosition = function(e) {
                    var t, i, r;
                    for (t = 0; t < e.length; t++)(i = e[t]).isActive && (r = i.activeContacts.length, i.collision.parentA.totalContacts += r, i.collision.parentB.totalContacts += r)
                }, N.solvePosition = function(e, t) {
                    var i, r, n, s, o, a, l, c, h, d = j._temp[0],
                        u = j._temp[1],
                        f = j._temp[2],
                        g = j._temp[3];
                    for (i = 0; i < e.length; i++)(r = e[i]).isActive && !r.isSensor && (s = (n = r.collision).parentA, o = n.parentB, a = n.normal, l = j.sub(j.add(o.positionImpulse, o.position, d), j.add(s.positionImpulse, j.sub(o.position, n.penetration, u), f), g), r.separation = j.dot(a, l));
                    for (i = 0; i < e.length; i++)(r = e[i]).isActive && !r.isSensor && (s = (n = r.collision).parentA, o = n.parentB, a = n.normal, h = (r.separation - r.slop) * t, (s.isStatic || o.isStatic) && (h *= 2), s.isStatic || s.isSleeping || (c = N._positionDampen / s.totalContacts, s.positionImpulse.x += a.x * h * c, s.positionImpulse.y += a.y * h * c), o.isStatic || o.isSleeping || (c = N._positionDampen / o.totalContacts, o.positionImpulse.x -= a.x * h * c, o.positionImpulse.y -= a.y * h * c))
            ...
            11: [function(e, t, i) {
                ...
                v.collides = function(e, t, i) {
                    ...
                    if (i && a) {
                        ...
                        if ((r = v._overlapAxes(e.vertices, t.vertices, e.axes)).overlap <= 0) return o.collided = !1, o;
                        if ((n = v._overlapAxes(t.vertices, e.vertices, t.axes)).overlap <= 0) return o.collided = !1, o;
            ...
            12: [function(e, t, i) {
                ...
                b._warming = .4, b._torqueDampen = 1, b._minLength = 1e-6, b.create = function(e) {
                    ...
                    for (i = 0; i < e.length; i += 1) n = !(r = e[i]).bodyA || r.bodyA && r.bodyA.isStatic, s = !r.bodyB || r.bodyB && r.bodyB.isStatic, n || s || b.solve(e[i], t)
            ...
            31: [function(e, t, i) {
                ...
                ! function() {
                    ...
                    "undefined" != typeof window && (r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                        ...
                        if (e.debugString) {
                            i.font = "12px Arial", o.wireframes ? i.fillStyle = "rgba(255,255,255,0.5)" : i.fillStyle = "rgba(0,0,0,0.5)";
                        ...
                        for (l.wireframes ? a.fillStyle = "indianred" : a.fillStyle = "rgba(0,0,0,0.5)", a.fill(), a.beginPath(), s = 0; s < t.length; s++)(r = t[s]).render.visible && (a.arc(r.positionPrev.x, r.positionPrev.y, 2, 0, 2 * Math.PI, !1), a.closePath());
                        ...
                        for (l.beginPath(), a = 0; a < t.length; a++)
                            if ((r = t[a]).isActive) {
                                ...
                                var h = 1;
                                (o = n.bodyB).isStatic || s.isStatic || (h = .5), o.isStatic && (h = 0), l.moveTo(o.position.x, o.position.y), l.lineTo(o.position.x - n.penetration.x * h, o.position.y - n.penetration.y * h), h = 1, o.isStatic || s.isStatic || (h = .5), s.isStatic && (h = 0), l.moveTo(s.position.x, s.position.y), l.lineTo(s.position.x + n.penetration.x * h, s.position.y + n.penetration.y * h)
                            }
                    ...
                    "undefined" != typeof window && (r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                        ...
                        if (e.currentBackground !== t) {
                            ...
                            if (i) {
                                ...
                                var s = o(e, t);
                                (r = e.sprites["bg-0"] = new PIXI.Sprite(s)).position.x = 0, r.position.y = 0, e.container.addChildAt(r, 0)
                            }
                        ...
                        if (i.visible)
                            if (i.sprite && i.sprite.texture) {
                                ...
                                var o = "b-" + t.id,
                                    a = e.primitives[o],
                                    l = e.container;
                                a || ((a = e.primitives[o] = h(e, t)).initialAngle = t.angle), -1 === f.indexOf(l.children, a) && l.addChild(a), a.position.x = t.position.x, a.position.y = t.position.y, a.rotation = t.angle - a.initialAngle
                            }
                    };
                    var c = function(e, t) {
...
function setupCopy() {
    for (var e = document.querySelector("#interactive__text").childNodes, t = 0; t < e.length; t++) {
        var i = e[t];
...
function addSlogan() {
    for (var e, t, i, r, n, s, o = defaultStyles.margin.left, a = defaultStyles.leading, l = [{
        ...
        e = o + (i = u.getBoundingClientRect(!0)).width / 2, t = a + i.height / 2, r = o + i.width, two.width < r && (l[l.index].width += defaultStyles.margin.right, l.index++, l.push({
        ...
        g.stroke = "rgb(255, 50, 50)", g.noFill(), g.opacity = .75, g.visible = debug;
...
function explode(e) {
    if (!e.object.isSymbol) {
        ...
        for (var a = 0; a < i.length; a++) {
            ...
            m.stroke = "rgb(255, 50, 50)", m.noFill(), m.opacity = .75, m.visible = debug;
...
function injectSymbol(e) {
    ...
    l.stroke = "rgb(255, 50, 50)", l.noFill(), l.opacity = .75, l.visible = debug;
